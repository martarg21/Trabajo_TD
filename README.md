...
Al igual que en el caso anterior se ha implementado un código que se ha reutilizado para introducir los distintos datos con los que se va a trabajar. Los datos están normalizados y, para que funcione el modelo correctamente, se han tenido que pasar a tensores.
...
A partir de haber obtenido las palabras más representativas de cada cluster (se han seleccionado 30), se ha procedido a su visualización en nubes de palabras. Para ello, se ha utilizado WordCloud.
